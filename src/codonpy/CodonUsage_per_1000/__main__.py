...
def get_cod_freq(headers: list, seqs: list) -> pd.DataFrame:
    ...
    # reorder the columns
    return df_codcount[['Codon', 'Amino_Acid', 'Frequency']]
...
def main():
    ...
    parser.add_argument('-out', help='Path of destination folder for output csv file',
                        type=str, default='./file.cu.csv', metavar='')
